...
export default function FranchiseSection() {
  ...
  return (
    <section id="franchise" className="py-24 bg-white text-slate-800 relative border-b border-slate-200">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,rgba(245,158,11,0.03),transparent_40%)]"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="space-y-6">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex gap-4 p-5 rounded-2xl bg-slate-50 border border-slate-200/60 hover:border-orange-500/30 transition-all shadow-sm">
            ...
            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-200 space-y-4">
              <p className="text-sm font-bold text-slate-800">신속 가맹 상담 문의 연락처</p>
          ...
          <div className="lg:col-span-7">
            <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-10 shadow-sm relative text-slate-800">
              {submitted ? (
                <div className="text-center py-16 space-y-6 animate-fade-in">
                  <div className="inline-flex p-4 bg-green-50 border border-green-200 rounded-full">
                    <CheckCircle className="w-12 h-12 text-green-600" />
                  </div>
                  <h3 className="text-2xl font-bold text-slate-900">가맹/배달대행 문의 완료!</h3>
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 rounded-xl bg-orange-600 hover:bg-orange-700 text-white font-semibold transition-colors cursor-pointer"
                  >
                    추가 상담 등록하기
                  </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <h3 className="text-xl font-bold border-b border-slate-200 pb-4 text-slate-900">
                    실시간 온라인 상담 신청
                  </h3>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3.5 px-4 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-orange-600 focus:bg-white transition-all text-sm"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3.5 px-4 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-orange-600 focus:bg-white transition-all resize-none text-sm"
                    />
                  </div>

                  <div className="flex items-center gap-3 bg-slate-50 p-4 rounded-xl border border-slate-200 text-xs text-slate-600">
                    <input id="franchise-privacy-agree" type="checkbox" required className="accent-orange-600 w-4 h-4 shrink-0 rounded" />
                  ...
                  <button
                    ...
                    type="submit"
                    disabled={loading}
                    className="w-full py-4 rounded-xl bg-orange-600 hover:bg-orange-700 disabled:bg-orange-800 text-white font-bold transition-colors cursor-pointer text-sm"
                  >
